...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('adminpanel/assets/css/adminlte.min.css')}}">
  <link rel="stylesheet" href="{{asset('adminpanel/plugins/toastr/toastr.min.css')}}">
  <!-- overlayScrollbars -->
        ...
        <a class="nav-link" data-toggle="dropdown" href="#">
          <i class="far fa-user"></i>  {{ Auth::user()->name }}
            ...
            <form id="logout-form" action="{{url('logout')}}}" method="POST" style="display: none;">
                                <input type="hidden" name="_token" value="MQpQ217yYMrJplWmN73avhtGp992YqnfX6VJev0h">
            </form>
        </div> --}}
